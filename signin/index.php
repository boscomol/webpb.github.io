...
<!-- Jumbotron -->
  ...
  <div class="title text-center">
    <h1 class="display-4 text-white user-select-none animate__animated animate__jackInTheBox">Sign In</h1>
  </div>
    ...
    <div class="row">
      <div class="col-md-4 form1 animate__animated animate__zoomIn">
        ...
        <div class="form-button">
          <button type="button" name="submit" type="submit" class="btn btn-primary tombol">Login</button>
        </div>
        <div class="form-link">
